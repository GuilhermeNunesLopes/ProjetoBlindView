...
const destinationInput = document.getElementById('destination-input'); // Adicione esta linha
        ...
        try {
            ...
            if (location) {
                ...
                if (data.instructions) {
                    ...
                    currentDetailedInstruction.innerText = "<center>Instruções encontradas:</center>";
